...
//  GPIO-18 - PIN FUNCTION = --Spare--
    GpioCtrlRegs.GPAPUD.bit.GPIO18 = 0;     // Enable pull-up on GPIO16 (SPISIMOA)
//    GpioCtrlRegs.GPAQSEL2.bit.GPIO18 = 3;   // Asynch input GPIO16 (SPISIMOA)
    GpioCtrlRegs.GPAMUX2.bit.GPIO18 = 2;    // Configure GPIO16 as SPISIMOA
...
//  GPIO-19 - PIN FUNCTION = --Spare--
    GpioCtrlRegs.GPAPUD.bit.GPIO19 = 0;     // Enable pull-up on GPIO16 (SPISIMOA)
    GpioCtrlRegs.GPAQSEL2.bit.GPIO19 = 3;   // Asynch input GPIO16 (SPISIMOA)
    GpioCtrlRegs.GPAMUX2.bit.GPIO19 = 2;    // Configure GPIO16 as SPISIMOA
