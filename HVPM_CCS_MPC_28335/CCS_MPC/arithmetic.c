...
#define J   0.0002 //0.00035 and 3e-5
#define Bz  0.0
#define Fai 0.07876
#define p   4.0
...
#define Temax 0.5   //1.27

float iqmax = Temax*2.0/3/p/Fai;  //Temax*2/3/p/Fai  0.5*2.1161 = 1.0587
float iqmin = -Temax*2.0/3/p/Fai; //-Temax*2/3/p/Fai
