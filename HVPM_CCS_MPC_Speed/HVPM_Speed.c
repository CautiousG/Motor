...
_iq  SpeedRef = _IQ(0.133333333333);           // For Closed Loop tests 0.13333333333  0.26666666667 0.1187
#endif
...
// ------------------------------------------------------------------------------
    ...
    //SpeedRef = 0.13333333333  0.26666666667
//    static Uint32 i1 = 0;
//    static Uint32 i2 = 0;
//    static Uint32 i3 = 0;
//    static int status = 0;  //  0: RPM:0    -   400
//                            //  1: RPM:400  -   800
//                            //  2: RPM:800  -   400
//                            //  3: RPM:Exit
//    if(lsw == 1 || lsw == 2)
...
//    static Uint32 ii2 = 0;
//    static Uint32 ii3 = 0;
//    static int status1 = 0; //  0: RPM:0    -   400
//                            //  1: ParaMis: 0.5
//                            //  2: ParaMis: 2.0
//                            //  3: RPM:Exit
//    if(lsw == 1 || lsw == 2)
...
//        cmc.iq = park1.Qs*5;
        ...
        PMSM_MPC_CCS(cmc.id, cmc.iq, cmc.we, cmc.idref, cmc.weref, &vd, &vq, cmc.Ts,ParaMis);
        cmc.vd = vd;
        cmc.vq = vq;
        pi_id.Out = vd;
        pi_iq.Out = vq;
